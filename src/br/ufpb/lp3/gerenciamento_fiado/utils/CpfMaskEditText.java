...
public class CpfMaskEditText extends EditText {

	private boolean isUpdating;
	private int positioning[] = { 0, 1, 2, 3, 5, 6, 7, 9, 10, 11, 13, 14 };

	public CpfMaskEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initialize();

	}

	public CpfMaskEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		initialize();
	...
	String text = CpfMaskEditText.this.getText().toString();
	...
	*/
	isUpdating = true;
	CpfMaskEditText.this.setText(cpf);

	CpfMaskEditText.this.setSelection(positioning[length]);
