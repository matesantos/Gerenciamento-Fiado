...
public class CepMaskEditText extends EditText{
	...
	public CepMaskEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initialize();
 
	}
 
	public CepMaskEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		initialize();
 
	}
 
	public CepMaskEditText(Context context) {
		super(context);
		initialize();
	...
	public String getCleanText() {
		String text = CepMaskEditText.this.getText().toString();
	...
	private void initialize() {
		...
		this.addTextChangedListener(new TextWatcher() {
			public void afterTextChanged(Editable s) {
				 ...
				 */
				isUpdating = true;
				CepMaskEditText.this.setText(cep);
 
				CepMaskEditText.this.setSelection(positioning[length]);
